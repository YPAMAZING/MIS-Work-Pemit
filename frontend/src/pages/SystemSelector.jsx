...
const SystemSelector = () => {
  ...
  const systems = [
    ...
    },
    {
      id: 'mis',
      title: 'MIS',
      description: 'Management Information System for analytics, reports, and business operations',
      ...
      features: [
        ...
        { icon: Wrench, text: 'Operations Control' },
      ],
      status: 'active',
    },
  ]
  ...
  const handleSystemSelect = (path) => {
    ...
    localStorage.setItem('selectedSystem', path.includes('workpermit') ? 'workpermit' : 'mis')
    navigate(path)
  }
